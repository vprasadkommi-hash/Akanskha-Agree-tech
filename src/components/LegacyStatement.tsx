    ...
    >
      <Container maxWidth="lg">
        ...
        >
          {isTe ? (
            <>
              రైతులు, వ్యవసాయ వ్యాపారాలు మరియు ఆవిష్కర్తలకు మద్దతు ఇవ్వడానికి మా వేదిక రూపొందించబడింది —{" "}
              <Box
                component="span"
                sx={{
              ...
              {" "}భూమిని గౌరవిస్తూ ఉత్పాదకతను పెంచే ఆచరణాత్మక సాంకేతిక సాధనాలను అందిస్తుంది.
            </>
          ) : (
            <>
