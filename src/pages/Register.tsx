...
export default function Register() {
  ...
  const farmerProgress = useMemo(() => {
    ...
    if (farmerForm.servicesNeeded.length > 0) filled++
  ...
  const cropOptions = [
    ...
    { key: "horticulture", en: "Horticulture (ఉద్యానవన పంటలు)", te: "తోటలు / పండ్ల తోటలు" },
  ...
  const providerEquipOptions = [
    ...
    { key: "jcb", en: "JCB / Earthmovers (భూమి చదును యంత్రాలు)", te: "JCB / ఎర్త్‌మూవర్లు" },
    { key: "borewell", en: "Borewell Drilling / Motors", te: "బోర్‌వెల్ & మోటార్ సర్వీసెస్" },
    { key: "labor", en: "Farm Labour Supply (సాగు కూలీల బృందం)", te: "సాగు కూలీల బృందం" },
  ]
        ...
        <Stack spacing={3} sx={{ mb: 4 }}>
          ...
          <Box textAlign="center">
            ...
            >
              {tabIndex === 0
                ? isTelugu
                  ? "మా సేవలను పొందడానికి రైతుగా నమోదు చేసుకోండి. డ్రోన్ స్ప్రేయింగ్, యంత్రాల బుకింగ్ మరియు AI పంట సలహాలు పొందండి."
                  : "Register as a farmer to access on-demand drone spraying, equipment booking, and AI crop healthcare."
                : isTelugu
                ? "ట్రాక్టర్లు, డ్రోన్లు, హార్వెస్టర్లు కలిగిన సర్వీస్ ప్రొవైడర్‌గా లేదా నిపుణుడిగా మా నెట్‌వర్క్‌లో చేరండి."
                : "Join our network as an agricultural service provider to offer drone, tractor, or machinery services."}
            </Typography>
          </Box>
        </Stack>
          ...
          <Box sx={{ mb: 3.5 }}>
            ...
            >
              ...
              >
                ...
                {isTelugu ? "నమోదు పురోగతి" : "Registration Progress"}
              </Typography>
              <Typography
                variant="subtitle2"
              ...
              <Stack spacing={3.5}>
                  ...
                  <Grid container spacing={2}>
                    <Grid size={{ xs: 12, sm: 6 }}>
                      <Typography variant="caption" sx={{ color: "rgba(255,255,255,0.7)", mb: 0.5, display: "block" }}>
                        {isTelugu ? "ఫీల్డ్ ఆపరేటర్ / ఏజెంట్ పేరు" : "Field Operator / Agent Name"}
                      </Typography>
                      <TextField
                        fullWidth
                        size="small"
                        placeholder={isTelugu ? "ఉదా: రాము లేదా testing" : "e.g. Ramu or Self"}
                    ...
                    <Grid size={{ xs: 12, sm: 6 }}>
                      <Typography variant="caption" sx={{ color: "rgba(255,255,255,0.7)", mb: 0.5, display: "block" }}>
                        {isTelugu ? "సిఫార్సు కోడ్ / ఏజెంట్ ID (ఐచ్ఛికం)" : "Referral Code / Agent ID (Optional)"}
                      </Typography>
                      <TextField
                        fullWidth
                        size="small"
                ...
                >
                  ...
                  <Grid container spacing={2}>
                    <Grid size={{ xs: 12, sm: 6 }}>
                      <Typography variant="caption" sx={{ color: "rgba(255,255,255,0.7)", mb: 0.5, display: "block" }}>
                        {isTelugu ? "రైతు పూర్తి పేరు *" : "Farmer Full Name *"}
                      </Typography>
                      <TextField
                        required
                        fullWidth
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid size={{ xs: 12, sm: 6 }}>
                      ...
                      <TextField
                        ...
                        fullWidth
                        size="small"
                        placeholder={isTelugu ? "ఉదా: గుంటూరు / ప్రకాశం / నెల్లూరు" : "District Name"}
                ...
                >
                  ...
                  <Typography variant="subtitle2" sx={{ fontWeight: 700, color: "#ffffff", mb: 1 }}>
                    {isTelugu ? "సాగు చేస్తున్న పంటలు (ఒకటి కంటే ఎక్కువ ఎంచుకోవచ్చు):" : "Crops Cultivated (Select all that apply):"}
                  </Typography>
                  ...
                  {/* Services Needed */}
                  <Typography variant="subtitle2" sx={{ fontWeight: 700, color: "#ffffff", mb: 1 }}>
                    {isTelugu ? "మీకు అవసరమైన సేవలు:" : "Services You Are Interested In:"}
                  </Typography>
              ...
              <Stack spacing={3.5}>
                ...
                >
                  ...
                  <Grid container spacing={2}>
                    <Grid size={{ xs: 12, sm: 6 }}>
                      <Typography variant="caption" sx={{ color: "rgba(255,255,255,0.7)", mb: 0.5, display: "block" }}>
                        {isTelugu ? "యంత్రాల / వాహనాల సంఖ్య" : "Total Number of Machines / Units"}
                      </Typography>
                      <TextField
                        fullWidth
                        size="small"
                    ...
                    <Grid size={{ xs: 12, sm: 6 }}>
                      ...
                      <TextField
                        ...
                        fullWidth
                        size="small"
                        placeholder={isTelugu ? "ఉదా: బాపట్ల, ఒంగోలు, చీరాల మండలాలు" : "e.g. Guntur, Bapatla, Ongole"}
